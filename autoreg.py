...
if '11111' == output:
    ...
    cur2=pm2.cursor()
    cur2.execute("delete from address where time<'2014-12-01'")
    cur2.execute("delete from avgbw4 where time<'2014-12-01'")
    cur2.execute("delete from avgbw6 where time<'2014-12-01'")
    cur2.execute("delete from avgrtt4 where time<'2014-12-01'")
    cur2.execute("delete from avgrtt6 where time<'2014-12-01'")
    cur2.execute("delete from avgloss4 where time<'2014-12-01'")
    cur2.execute("delete from avgloss6 where time<'2014-12-01'")
    cur2.execute("delete from web_perf4 where time<'2014-12-01'")
    cur2.execute("delete from web_perf6 where time<'2014-12-01'")
    pm2.commit()
